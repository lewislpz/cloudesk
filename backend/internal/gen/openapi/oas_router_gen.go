...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		case '/': // Prefix: "/"
			...
			switch elem[0] {
			case 'a': // Prefix: "api/v1/organizations/"

				if l := len("api/v1/organizations/"); len(elem) >= l && elem[0:l] == "api/v1/organizations/" {
					elem = elem[l:]
				} else {
					break
				}
			...
			case 'a': // Prefix: "api/v1/organizations/"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Read an organization"
						r.operationID = "getOrganization"
						r.operationGroup = ""
						r.pathPattern = "/api/v1/organizations/{organizationId}"
						r.args = args
						r.count = 1
						return r, true
					default:
				...
				case 'l': // Prefix: "live"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.summary = "Check process liveness"
				...
				case 'r': // Prefix: "ready"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.summary = "Check process readiness"
