...
The repository is now initialized on Git. M0 Tasks 1 through 3 have added the root
...
package boundaries, and process-level shutdown tests. This remains engineering
foundation, not a product feature or deployed runtime.
